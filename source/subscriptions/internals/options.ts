 ...
 */
@RestDB.Schema.Entity('Subscription/Options')
@Class.Describe()
export class Options extends Class.Null {
   ...
   */
  @RestDB.Schema.Enumeration(() => Object.values(Transactions.Types.ManualValidation))
  @RestDB.Schema.Null()
  @Class.Public()
  public manualValidation?: Transactions.Types.ManualValidation | null;
}
