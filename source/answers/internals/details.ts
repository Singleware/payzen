...
export class Details extends Class.Null {
   ...
   */
  @RestDB.Schema.Null()
  @RestDB.Schema.Enumeration(Object.values(Types.Details.Context))
  @Class.Public()
  public creationContext?: Types.Details.Context | null;
   ...
   */
  @RestDB.Schema.Null()
  @RestDB.Schema.Enumeration(Object.values(Types.Details.Liability))
  @Class.Public()
  public liabilityShift?: Types.Details.Liability | null;
